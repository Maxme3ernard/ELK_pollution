...
`${GOPATH}/src/github.com/Maxme3ernard/polutbeat`
...
```
git remote set-url origin https://github.com/Maxme3ernard/polutbeat
...
in the same directory with the name polutbeat.
...
```
mkdir -p ${GOPATH}/src/github.com/Maxme3ernard/polutbeat
git clone https://github.com/Maxme3ernard/polutbeat ${GOPATH}/src/github.com/Maxme3ernard/polutbeat
```
